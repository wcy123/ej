...
hell_xmpp_server_1(Config) ->
    ...
    true = is_map(Vars0),
    Vars00 = ej_c2s:add_bottom_module(dummy_sink,Vars0),
    Vars1 = ej_c2s:ul(#sp_cmd{ args = {tcp, 1,  << "<?xml version='1.0'?>" >>}, label = <<"tcp">> }, dummy_sink, Vars00),
    true = is_map(Vars1),
    ...
    Vars2 = ej_c2s:ul(#sp_cmd{ args = {tcp, 1,  Data}, label = <<"tcp">> }, dummy_sink,Vars1),
    true = is_map(Vars2),
...
hello_xmpp_server_undefined_ip_1(Config) ->
    ...
    Vars1 = ej_c2s:ul(#sp_cmd{ args = {tcp, 1,  << "<?xml version='1.0'?>" >>}, label = <<"tcp">> }, dummy_sink, Vars01),
    true = is_map(Vars1),
    Data = << "<stream:stream to='localhost' xmlns:stream='http://etherx.jabber.org/streams' xmlns='jabber:client' version='1.0' xml:lang='1234567890123456789012345678901234567890'>" >>,
    Vars2 = ej_c2s:ul(#sp_cmd{ args = {tcp, 1,  Data}, label = <<"tcp">> }, dummy_sink,Vars1),
    true = is_map(Vars2),
...
hello_xmpp_server_wrong_password_1(Config) ->
    ...
    Vars3 = ej_c2s:ul(#sp_cmd{ args = {tcp, 1,  Data2}, label = <<"tcp">> }, dummy_sink, Vars2),
    Output0 = dummy_sink:get_output(Vars3),
    {data, [Output]} = Output0,
...
hello_xmpp_server_unknown_ns_1(Config) ->
    ...
    Vars3 = ej_c2s:ul(#sp_cmd{ args = {tcp, 1,  Data}, label = <<"tcp">> }, dummy_sink, Vars2),
    true = is_map(Vars3),
    ...
    Vars4 = ej_vars:set(output, <<"no_output">>, dummy_sink, Vars3),
    Vars5 = ej_c2s:ul(#sp_cmd{ args = {tcp, 1,  Data2}, label = <<"tcp">> }, dummy_sink, Vars4),
